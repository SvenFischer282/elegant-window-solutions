...
const AluminumLayout = () => {
  ...
  const framexFeatures = [
    {
      name: "Ľahkosť a pevnosť",
      description: "Ideálne pre trvanlivé a ľahké konštrukcie",
    },
    {
      name: "Odolnosť proti korózii",
      description: "Eloxácia alebo práškové lakovanie",
    },
            ...
            <div className="text-center text-background px-4">
              <AnimatedSection>
                ...
                <p className="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto">
                  Ľahké a odolné riešenia pre moderné stavby
                </p>
              </AnimatedSection>
            </div>
          </div>
              ...
              <AnimatedSection delay={100}>
                <div className="space-y-6">
                  <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed">
                    Ľahké hliníkové systémy sú ideálnou voľbou, ak potrebujete
                    zabezpečiť maximálne prirodzené osvetlenie a nemáte prísne
            ...
            <AnimatedSection delay={450}>
              <div className="max-w-4xl mx-auto text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Pracujeme s hliníkovým profilom Framex – kvalitný konštrukčný
                  profil certifikovaný podľa európskych noriem.
                </p>
              </div>
            </AnimatedSection>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    ...
                    <p className="text-sm uppercase tracking-wider text-primary mb-4">
                      Studený hliníkový systém
                    </p>
                    <p className="text-lg text-muted-foreground leading-relaxed">
                      Studený hliníkový systém určený pre konštrukcie s nízkymi
                      požiadavkami na tepelnú izoláciu – nevykurované
                      miestnosti, interiérové priečky alebo výklady.Montážna
                      hĺbka rámu: 38 mm. Inštalačná (montážna) hĺbka krídla: 46
                      mm
                    </p>
                  </div>
                  <img
                    src="https://dgvswatqmbvaqfznixyg.supabase.co/storage/v1/object/public/okna/framex_38.png"
                    alt="Framex 38 image"
                  />
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection delay={600}>
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div className="order-2 md:order-1">
                    <img
                      src="https://dgvswatqmbvaqfznixyg.supabase.co/storage/v1/object/public/okna/framex_ft72.png"
                      alt="Framex 72 image"
                    />
                  </div>
