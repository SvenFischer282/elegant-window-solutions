...
const DoorsLayout = () => {
  ...
  const description =
    "Kvalitné vstupné a interiérové dvere, ktoré spájajú funkčnosť, bezpečnosť a estetiku. Ponúkame široký výber dverí pre rôzne typy objektov - od rodinných domov až po komerčné priestory. Naše dvere nevyžadujú špeciálnu údržbu a zachovávajú si dlhodobo estetický vzhľad.";
  ...
  const technologies = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1534237710431-e2fc698436d0?auto=format&fit=crop&w=400&q=80",
    },
    {
      name: "Protipožiarne dvere",
      description: "EI30 - EI90 | Požiarna odolnosť",
      image:
        "https://images.unsplash.com/photo-1585128792020-803d29415281?auto=format&fit=crop&w=400&q=80",
    },
    {
